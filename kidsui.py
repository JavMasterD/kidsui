...
# app = KidsUIApp("My App")
# app.label("Hello!", color=(1, 0, 0, 1))
# app.button("Click", lambda: app.alert("You clicked!"), background_color=(0, 1, 0, 1))
# app.image("my_image.png")
# app.colored_box(color=(0.5, 0.5, 1, 1))
# app.run()
